...
from reports import Promedios_Anuales_Por_Grupo
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.radioButton_anual.setGeometry(QtCore.QRect(190, 70, 151, 17))
        ...
        self.radioButton_acumulado.setGeometry(QtCore.QRect(190, 130, 171, 17))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Promedios de estudiantes por grupo"))
        ...
        self.radioButton_anual.setText(_translate("Dialog", "Promedio anual"))
        self.radioButton_acumulado.setText(_translate("Dialog", "Promedio acumulado"))
    ...
    def on_pushButtonMostrarReporte(self):
        if(self.radioButton_acumulado.isChecked()):
            Promedios_Anuales_Por_Grupo.report_promedios_acumulados_por_grupo(self.comboBox_cursos.currentText(),
                                    int(self.comboBox_annos.currentText()), int(self.comboBox_grupos.currentText()))
        else:
            Promedios_Anuales_Por_Grupo.report_promedios_anuales_por_grupo(self.comboBox_cursos.currentText(),
                                    int(self.comboBox_annos.currentText()), int(self.comboBox_grupos.currentText()))
