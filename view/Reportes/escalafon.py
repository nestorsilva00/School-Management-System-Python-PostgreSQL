...
from reports import Escalafon



class Ui_DialogEscalafon(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.radioButton_anual.setText(_translate("Dialog", "Escalafón por grupo"))
        self.radioButton_acumulado.setText(_translate("Dialog", "Escalafón por año"))
    ...
    def on_pushButtonMostrarReporte(self):
        if(self.radioButton_acumulado.isChecked()):
           Escalafon.report_escalafon_por_anno(self.comboBox_cursos.currentText(),
                                                 int(self.comboBox_annos.currentText()))
        else:
            Escalafon.report_escalafon_por_grupo(self.comboBox_cursos.currentText(),
                                                 int(self.comboBox_annos.currentText()),
